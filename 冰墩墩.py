...
turtle.color("gold")
print("BEIJING 2022")
turtle.write("BEIJING 2022", font=('Arial', 60, 'bold italic'))
time.sleep(2)
turtle.clear()
turtle.goto(-140, 0)
print("一起向未来")
turtle.write("一起向未来", font=('Arial', 40))
time.sleep(2)
turtle.clear()
turtle.goto(-220, 0)
print("Together for a Shared Future")
turtle.write("Together for a Shared Future", font=('Arial', 25, 'bold italic'))
time.sleep(2)
turtle.clear() 
